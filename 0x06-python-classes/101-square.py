...
class Square:
    ...
    def position(self, value):
        ...
        Args:
            value (tuple): The position coordinates as a
            tuple of two positive integers.

        Raises:
            TypeError: If value is not a tuple or if
            any integer in the tuple is less than 0.
        """
    ...
    def pos_print(self):
        """Generate the string representation of the
        square with the specified position."""
        pos = ""
        if not self.size:
            return "\n"
